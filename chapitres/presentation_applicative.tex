...
\begin{itemize}
  ...
  \item de gérer les règlements, les documents administratifs
        (\textit{MAPC}), les contrôles, les notes internes et les
...
\begin{figure}[H]
  \centering
  \imgw{page_de_connexion.png}{0.7\textwidth}
...
\begin{figure}[H]
  \centering
  \imgw{onglet_demande_de_financement.png}{0.9\textwidth}
...
\begin{figure}[H]
  \centering
  \imgw{schema_des_flux_status.png}{0.85\textwidth}
...
\begin{figure}[H]
  \centering
  \imgw{verrou_selon_statut.png}{0.85\textwidth}
