...
\imgwlogo{logo_open_project.jpeg}{1.5cm}, qui centralise le backlog, les
...
\imgwlogo{logo_mattermost.png}{1.5cm}.
...
\begin{itemize}
  ...
  \item \textbf{Linux} \imgwlogo{logo_linux.png}{1.2cm}  -  système
  ...
  \item \textbf{Docker} \imgw{logo_docker.png}{1.2cm}  -  conteneurisation
        ...
        fichiers (MinIO) \imgwlogo{logo_minio.png}{1.2cm}, backend Django.
\end{itemize}
...
\begin{itemize}
  \item \ \imgw{logo_latex.jpeg}{1.2cm} utilisation de Latex pour la réaction de ce rapport.
\end{itemize}
...
\begin{itemize}
  ...
  \item une \textbf{génération de rapports PDF} déléguée à un serveur
        \textbf{JasperReports} \imgwlogo{logo_jasper.png}{1.2cm}externe, sollicité par le backend pour la
